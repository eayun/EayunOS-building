...
Name:           %{vdsm_name}
Version:        4.16.7
Release:        1.gitee68fd7%{?dist}%{?extra_release}
...
install -dDm 0755 %{buildroot}/usr/local/var/log/vdsm
touch %{buildroot}/usr/local/var/log/vdsm/{connectivity.log,mom.log,supervdsm.log,vdsm.log}
...
touch /usr/local/var/log/vdsm/{connectivity.log,mom.log,supervdsm.log,vdsm.log}
chmod 0644 /usr/local/var/log/vdsm/{connectivity.log,mom.log,supervdsm.log,vdsm.log}
chown vdsm:kvm /usr/local/var/log/vdsm/{connectivity.log,mom.log,vdsm.log}
chown root:root /usr/local/var/log/vdsm/supervdsm.log
...
%ghost %config %attr(0644, %{vdsm_user}, %{vdsm_group}) /usr/local/var/log/vdsm/connectivity.log
%ghost %config %attr(0644, %{vdsm_user}, %{vdsm_group}) /usr/local/var/log/vdsm/mom.log
%ghost %config %attr(0644, root, root) /usr/local/var/log/vdsm/supervdsm.log
%ghost %config %attr(0644, %{vdsm_user}, %{vdsm_group}) /usr/local/var/log/vdsm/vdsm.log
